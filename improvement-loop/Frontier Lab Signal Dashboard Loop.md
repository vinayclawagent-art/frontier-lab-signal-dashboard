...
next_focus: "During the next real frontier-lab scan, fill the Source-Backed Signal Evidence Attachment and Signal Route Promotion Decision Card for exactly one handle before updating the Handle Route Matrix, trend-rows.yaml, or any package backlog."
...
8. Decide whether the draft skill should be promoted after a successful scan.
