...
next_focus: "Run the first real frontier-lab scan using account-registry.yaml plus the First Scan Capture Ledger and capture up to three high-signal posts."
...
3. Run one scan and capture up to three high-signal posts.
