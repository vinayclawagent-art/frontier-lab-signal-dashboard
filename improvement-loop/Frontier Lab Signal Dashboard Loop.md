...
2. Run one scan and capture up to three high-signal posts.
3. Add “last useful signal” and “best route” fields per handle.
4. Decide whether the draft skill should be promoted after a successful scan.
